...
const getAnswerByContestId = (request, response) => {
...
const deleteAnswerByContestId = (request, response) => {
    const contestnumber = parseInt(request.params.id)
...
module.exports = { getAnswer, createAnswer, getAnswerByContestId, deleteAnswerByContestId, updateAnswer};