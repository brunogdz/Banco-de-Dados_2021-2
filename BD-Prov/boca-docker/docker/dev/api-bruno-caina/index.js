...
app.get('/api/problem/:id/answer', authenticate, answer.getAnswerById)
app.post('/api/answer', authenticate, answer.createAnswer)
app.delete('/api/problem/:id/answer', authenticate, answer.deleteAnswer)
